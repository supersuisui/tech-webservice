 ...
 * 
 */
@WebServiceClient(name = "PictureService", targetNamespace = "http://service.sumingjie.com/", wsdlLocation = "http://localhost:8080/PictureService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PICTURESERVICE_QNAME = new QName("http://service.sumingjie.com/", "PictureService");
    ...
    public PictureWebService getPictureWebServicePort() {
        return super.getPort(new QName("http://service.sumingjie.com/", "PictureWebServicePort"), PictureWebService.class);
    }
    ...
    public PictureWebService getPictureWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sumingjie.com/", "PictureWebServicePort"), PictureWebService.class, features);
    }
